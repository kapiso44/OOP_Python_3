...
class Organizm(ABC):
    ...
    def info(self):
        return f"{self.nazwa} {self.lokacja} Siła: {self.sila} Inicjatywa: {self.inicjatywa} Wiek: {self.wiek}"

    def generujKomende(self):
        return f"{self.znak} {self.lokacja.getX()} {self.lokacja.getY()} {self.sila} {self.inicjatywa} {self.wiek}"
